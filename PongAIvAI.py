...
def init_game():
    ...
    round_1, w = game_loop(screen, paddles, ball, table_size, clock_rate, turn_wait_rate, score_to_win, 1)
    ...
    round_2, q = game_loop(screen, paddles, ball, table_size, clock_rate, turn_wait_rate, score_to_win, 1)
    if q == 'left':
        your_score += 1
    else:
        opp_score += 1
...
if __name__ == '__main__':
    ...
    ys, ops = init_game()
      ...
      opp_tot_score += ops
    print games
    print ' your score', your_tot_score
    print 'opp score', opp_tot_score
